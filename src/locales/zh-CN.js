...
export default {
  ...
  'menu.platform.home.entrance': '快捷入口设置',
  'menu.platform.home.sections': '版块设置',
  'menu.platform.content': '内容管理',
  'menu.platform.contentEdit': '内容编辑',
  'menu.platform.category': '分类管理',
  'menu.platform.article': '文章管理',
  'menu.platform.attachment': '附件管理',
  'menu.platform.attachmentEdit': '附件编辑',
  'menu.platform.provider': '提供者管理',
  'menu.platform.providerEdit': '提供者编辑',
  'menu.home': '首页',
  'menu.dashboard': 'Dashboard',
  'menu.dashboard.monitor': '监控页',
  'menu.dashboard.analysis': '分析页',
  'menu.dashboard.workplace': '工作台',
  'menu.dashboard.home': '首页管理',
  'menu.form': '表单页',
